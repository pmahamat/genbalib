...
class ReservationsApi
{
     ...
     * @return \Genba\Client\Model\ReservationResponse
     */
     ...
     * @throws \Genba\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Genba\Client\Model\ReservationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function reservationsGetReservationWithHttpInfo($reservationid, $authorization)
    {
        $returnType = '\Genba\Client\Model\ReservationResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Genba\Client\Model\ReservationResponse',
     ...
     *
     * @param  \Genba\Client\Model\ReservationRequest $request Request for the reservation (required)
     * @param  string $authorization Access token from AAD. Should start with &#39;Bearer &#39;. (required)
     *
     * @throws \Genba\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
